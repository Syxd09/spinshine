  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Fabric Care Services — SpinShine" },
      {
        ...
        content:
          "High-end cleaning for curtains, carpets, blankets, mattresses, and sofas in Bangalore.",
      },
          ...
          <div className="mx-auto max-w-5xl text-center space-y-6 relative">
            <Reveal>
              ...
              <h1 className="mt-4 text-5xl sm:text-6.5xl lg:text-7.5xl font-black tracking-tight leading-none">
                Premium care for{" "}
                <span className="font-serif italic font-semibold text-teal-400">every fabric.</span>
              </h1>
              <p className="mt-6 mx-auto max-w-2xl text-sm sm:text-base text-white/60 leading-relaxed">
                We believe different materials require custom chemistry and techniques. From
                delicate silk panels to heavy wool rugs, we treat nothing as generic laundry.
              </p>
            </Reveal>
          </div>
        </section>
                  ...
                  >
                    <div className={`${isEven ? "lg:order-1" : "lg:order-2"} space-y-6`}>
                      ...
                      <div className="p-4 rounded-xl border border-gold/20 bg-card inline-flex items-center gap-2.5 shadow-soft relative overflow-hidden before:absolute before:left-0 before:top-0 before:bottom-0 before:w-1 before:bg-gold">
                        ...
                        <span className="font-display text-xl font-black text-royal">
                          ₹{s.rate}
                        </span>
                        ...
                        <ul className="space-y-3.5">
                          {workflow.map((step, sIdx) => {
                            ...
                            return (
                              <li
                                key={sIdx}
                                className="text-xs sm:text-sm text-muted-foreground flex items-start gap-3"
                              >
                    ...
                    <div
                      className={`overflow-hidden rounded-3xl border border-border/80 bg-card p-2 shadow-soft relative group ${
          ...
          <div className="mx-auto max-w-2xl space-y-6 relative">
            <Reveal>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-foreground tracking-tight">
                Restore your home's hygiene
              </h2>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                Schedule your pick-up or on-site cleaning service. Instant availability, flexible
                slots, and no upfront payments.
              </p>
