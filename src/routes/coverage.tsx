  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Service Area Coverage — SpinShine" },
      {
        ...
        content:
          "Locality coverage checker for SpinShine pickup and on-site cleaning in Bangalore.",
      },
...
function CoveragePage() {
  ...
  const inside = loc ? loc.km <= settings.radiusKm : false;
      ...
      <main className="pt-24">
          ...
          <div className="mx-auto max-w-5xl text-center space-y-6 relative">
            <Reveal>
              ...
              <h1 className="mt-4 text-5xl sm:text-6.5xl lg:text-7.5xl font-black tracking-tight leading-none">
                Bangalore{" "}
                <span className="font-serif italic font-semibold text-teal-400">coverage.</span>
              </h1>
              <p className="mt-6 mx-auto max-w-2xl text-sm sm:text-base text-white/60 leading-relaxed">
                We operate within a 30 km pickup and delivery radius from our central care hub. For
                locations outside this radius, our on-site cleaning units are still available to
            ...
            <div className="space-y-6">
              ...
              >
                <div className="space-y-2">
                  ...
                  >
                    <option value="" className="font-semibold text-muted-foreground">
                      Choose an area...
                    </option>
                    {localities.map((l) => (
                    ...
                    {inside ? (
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground leading-relaxed">
                          Great! **{loc.name}** is **{loc.km} km** from our hub, which is within our
                          **{settings.radiusKm} km** radius. Both pickup & return and on-site
                          cleaning are fully supported!
                        </p>
                      </div>
                    ) : (
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground leading-relaxed">
                          **{loc.name}** is **{loc.km} km** from our hub. This is outside our **
                          {settings.radiusKm} km** pickup zone, but our mobile teams can still
                          perform **on-site curtain, carpet, mattress, and sofa cleaning** directly
                          at your home!
                        </p>
                      </div>
                    )}
        ...
        <section className="bg-card border-t border-border py-28 px-6 relative overflow-hidden bg-grid-pattern">
          ...
          <div className="mx-auto max-w-5xl space-y-6 relative">
            <Reveal>
              <h2 className="text-3xl font-extrabold text-foreground text-center tracking-tight">
                Locality Availability Directory
              </h2>
            ...
            <div className="mt-16 grid gap-6 sm:grid-cols-2 md:grid-cols-3">
              {[...localities]
                ...
                .map((l) => {
                  const inZone = l.km <= settings.radiusKm;
                  return (
                    <Reveal key={l.name}>
                      <SpotlightCard
                        className="p-px hover:shadow-soft"
                        innerClassName="p-5 flex justify-between items-center text-sm bg-card"
                      >
                        <div>
                        ...
                        <span
                          className={`rounded-full px-3 py-1 text-[9px] font-extrabold uppercase tracking-wider ${
                            inZone ? "bg-teal/10 text-teal-700" : "bg-royal/10 text-royal"
                          }`}
                        >
